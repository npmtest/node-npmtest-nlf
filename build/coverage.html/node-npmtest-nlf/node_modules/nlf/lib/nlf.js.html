...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nlf/node_modules/nlf/lib/nlf.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-nlf">npmtest-nlf (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-nlf/node_modules/nlf/lib/nlf.js</span></h1>
    <h2>
        
        Statements: <span class="metric">75.15% <small>(127 / 169)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">53.77% <small>(57 / 106)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">92% <small>(23 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">75.15% <small>(127 / 169)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nlf/node_modules/nlf/lib/</a> &#187; nlf.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function isDevDependency(moduleData) {</span>
&nbsp;
	// this might be the root object - which by definition is production
<span class="cstat-no" title="statement not covered" >	if (moduleData.parent === undefined) {</span>
<span class="cstat-no" title="statement not covered" >		return false;</span>
	}
&nbsp;
<span class="cstat-no" title="statement not covered" >	if (moduleData.extraneous) {</span>
<span class="cstat-no" title="statement not covered" >		return true;</span>
	}
&nbsp;
<span class="cstat-no" title="statement not covered" >	var dependencies = moduleData.parent.devDependencies || {},</span>
		dependencyName;
&nbsp;
	// look for this module in the production dependencies of the parent
	// and return true if it is found
<span class="cstat-no" title="statement not covered" >	for (dependencyName in dependencies) {</span>
<span class="cstat-no" title="statement not covered" >		if (dependencies.hasOwnProperty(dependencyName)) {</span>
<span class="cstat-no" title="statement not covered" >			if (dependencyName === moduleData.name) {</span>
<span class="cstat-no" title="statement not covered" >				return true;</span>
			}
		}
	}
...
&nbsp;
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (options.production &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >isDevDependency(moduleData))</span> {
...
&nbsp;
				...
				var dependencies = moduleData.dependencies || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span>
					name;
&nbsp;
				for (name in dependencies) {
					<span class="missing-if-branch" title="else path not taken" >E</span>if (dependencies.hasOwnProperty(name)) {
						<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof dependencies[name] === 'object') {
...
<span class="cstat-no" title="statement not covered" >							console.warn('Warning: dependency "' + name +</span>
								'" probably not installed.');
<span class="cstat-no" title="statement not covered" >							console.warn('please install dependencies from npm before running nlf');</span>
						}
					}
				}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		return callback(new Error('pattern must be a string'));</span>
	}
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof directory !== 'string') {
<span class="cstat-no" title="statement not covered" >		return callback(new Error('directory must be a string'));</span>
	}
&nbsp;
...
&nbsp;
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if (typeof license === 'string' || typeof license === 'object') {
		module.licenseSources.package.add(new PackageSource(license));
	}
&nbsp;
	// correct use of licenses array
	<span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(licenses)) {
<span class="cstat-no" title="statement not covered" >		for (var index = 0; index &lt; licenses.length; index++) {</span>
<span class="cstat-no" title="statement not covered" >			module.licenseSources.package.add(</span>
				new PackageSource(licenses[index])
			);
		}
	} else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof licenses === 'string' || typeof licenses === 'object') {
		// some modules incorrectly have a string or object licenses property
<span class="cstat-no" title="statement not covered" >		return module.licenseSources.package.add(new PackageSource(licenses));</span>
	}
}
&nbsp;
/**
...
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (!moduleData._id || moduleData._id === '@') {
<span class="cstat-no" title="statement not covered" >		return 'unknown(' + moduleData.path + ')@0.0.0';</span>
	}
&nbsp;
...
&nbsp;
	var repository = (moduleData.repository || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.url || <span class="branch-1 cbranch-no" title="branch not covered" >'(none)';</span>
	var directory = moduleData.path;
	var id = createId(moduleData);
	var name = moduleData.name || <span class="branch-1 cbranch-no" title="branch not covered" >id;</span>
	var version = moduleData.version || <span class="branch-1 cbranch-no" title="branch not covered" >'0.0.0';</span>
...
function processOptionSummaryMode(options) {
	options.summaryMode = options.summaryMode || <span class="branch-1 cbranch-no" title="branch not covered" >'simple';</span>
	<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options.summaryMode !== 'string') {
<span class="cstat-no" title="statement not covered" >		throw new Error('options.summaryMode must be a string');</span>
	}
...
&nbsp;
	options.directory = options.directory || <span class="branch-1 cbranch-no" title="branch not covered" >process.cwd();</span>
	options.production = options.production || false;
	options.depth = typeof options.depth === 'number' ? options.depth : <span class="branch-1 cbranch-no" title="branch not covered" >Infinity;</span>
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options.directory !== 'string') {
<span class="cstat-no" title="statement not covered" >		throw new Error('options.directory must be a string');</span>
	}
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options.production !== 'boolean') {
<span class="cstat-no" title="statement not covered" >		throw new Error('options.production must be a boolean');</span>
	}
&nbsp;
...
&nbsp;
	// process arguments
	<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options === 'function' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >callback === undefined)</span> {
...
&nbsp;
	 ...
	 */
<span class="fstat-no" title="function not covered" >	function log(output, details) {</span>
<span class="cstat-no" title="statement not covered" >		console.error('Error in reading node_module dependencies, error was:',</span>
			output, details);
	}
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (!fileExistsSync(path.join(options.directory, 'package.json'))) {
<span class="cstat-no" title="statement not covered" >		return callback(new Error('No package.json file found.'));</span>
	}
&nbsp;
...
&nbsp;
		<span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >			console.error('Serious problem reading node_module dependencies');</span>
<span class="cstat-no" title="statement not covered" >			return callback(err);</span>
		}
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Fri Apr 21 2017 15:28:23 GMT+0000 (UTC)</div>
</div>
</body>
</html>

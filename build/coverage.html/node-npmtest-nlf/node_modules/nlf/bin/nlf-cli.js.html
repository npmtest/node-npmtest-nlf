...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nlf/node_modules/nlf/bin/nlf-cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nlf/node_modules/nlf/bin/nlf-cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nlf/node_modules/nlf/bin/</a> &#187; nlf-cli.js</div>
</div>
<div class="body">
...
<span class="missing-if-branch" title="if path not taken" >I</span>if (program.csv) {
<span class="cstat-no" title="statement not covered" >	format = require('../lib/formatters/csv');</span>
} else {
	format = require('../lib/formatters/standard');
}
&nbsp;
...
&nbsp;
	<span class="missing-if-branch" title="else path not taken" >E</span>if (data &amp;&amp; data.length &gt; 0) {

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nlf/node_modules/nlf/lib/license-collection.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nlf/node_modules/nlf/lib/license-collection.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nlf/node_modules/nlf/lib/</a> &#187; license-collection.js</div>
</div>
<div class="body">
...
&nbsp;
	...
	for (name in dedup) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (dedup.hasOwnProperty(name)) {
			output.push(name);
		}
	}
&nbsp;
...
<span class="cstat-no" title="statement not covered" >		throw new Error('source must be an object');</span>
	}
&nbsp;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-nlf/node_modules/nlf/lib/module.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-nlf/node_modules/nlf/lib/module.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-nlf/node_modules/nlf/lib/</a> &#187; module.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >		throw new Error('id must be defined');</span>
	}
&nbsp;
	<span class="missing-if-branch" title="if path not taken" >I</span>if (!directory) {
<span class="cstat-no" title="statement not covered" >		throw new Error('directory must be defined');</span>
	}
&nbsp;
	this.id = id;
	this.name = name;
	this.version = version;
	this.repository = (repository || <span class="branch-1 cbranch-no" title="branch not covered" >'(none)')</span>
		.replace('git://', 'http://')
		.replace('.git', '')
		.replace(/^git\+/, '');
...
&nbsp;
	...
	for (licenseSourceName in this.licenseSources) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this.licenseSources.hasOwnProperty(licenseSourceName)) {
...
&nbsp;
	...
	for (licenseName in dedupe) {
		<span class="missing-if-branch" title="else path not taken" >E</span>if (dedupe.hasOwnProperty(licenseName)) {
			output.push(licenseName);
		}
	}
&nbsp;
	// add unknown, if there are none
	<span class="missing-if-branch" title="if path not taken" >I</span>if (output.length === 0) {
<span class="cstat-no" title="statement not covered" >		output.push('Unknown');</span>
	}
&nbsp;
	return output.sort();
};
